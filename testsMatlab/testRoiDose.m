classdef testRoiDose < matlab.unittest.TestCase
    ...
    methods (TestClassSetup)
        function setupOnce(me)
            ...
            me.Gtv1 = RoiDose('GTV-1', me.calcGrid, me.rtStruct, me.rtDose);
            me.Gtv2 = RoiDose('GTV-2', me.calcGrid, me.rtStruct, me.rtDose);
            ...
            me.mismatchGtv1 = RoiDose('GTV-1', me.mismatchCalcGrid, me.mismatchRtStruct, me.mismatchRtDose);
        end
    end    
...
%         end
        ...
        function testGtv1(me)
            ...
            verifyEqual(me, me.Gtv1.dose('min'), me.doseMinGtv1, 'RelTol', me.relativeError);            
            verifyEqual(me, me.Gtv1.dose('mean'), me.doseMeanGtv1, 'RelTol', me.relativeError);
            verifyGreaterThanOrEqual(me, me.Gtv1.dose('mean'), me.Gtv1.dose('min'));            
            verifyEqual(me, me.Gtv1.dose('max'), me.doseMaxGtv1, 'RelTol', me.relativeError);             
            verifyGreaterThanOrEqual(me, me.Gtv1.dose('max'), me.Gtv1.dose('mean'));
            verifyEqual(me, me.volume48GyGtv1, me.Gtv1.volumePercentageWithDoseOf(48), 'RelTol', me.relativeError);            
            verifyEqual(me, me.dose2PercentGtv1, me.Gtv1.doseToCertainVolumePercentage(2), 'RelTol', me.relativeError); 
        end
